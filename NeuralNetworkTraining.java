...
http://freeconnection.blogspot.hu/2012/09/solving-xor-with-mlp.html
*/
...
public class NeuralNetworkTraining {
	...
	public NeuralNetworkTraining(int inputSize, int[] layersSize) {
	...
	public static void main(String[] args) throws Exception {
		...
		NeuralNetworkTraining mlp = new NeuralNetworkTraining(2, new int[] { 2, 1 });
